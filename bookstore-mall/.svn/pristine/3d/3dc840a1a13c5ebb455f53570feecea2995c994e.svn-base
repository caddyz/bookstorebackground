...
public class UserController {
	...
	public User findUSer(@PathVariable("account")String account,@PathVariable("password")String password){
		...
		if(user.getEmail().equals(account)&&user.getPassword().equals(AppMD5Util.convertMD5(password))){
			user.setPassword(AppMD5Util.convertMD5(user.getPassword()));
			return user;
		}
		return null;
	}
	...
	public Integer authCode(@PathVariable("email")String email){
...
//		return AppMD5Util.convertMD5(password);
//	}
...
//		User user = userService.getUserColumn(email,AppMD5Util.convertMD5(password));
//		if(user!=null){
//			return user;
//		}else{
//			
