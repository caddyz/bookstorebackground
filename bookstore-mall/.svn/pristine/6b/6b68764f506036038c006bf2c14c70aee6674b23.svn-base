...
public class UserDaoimpl implements UserDao{
	...
	public User selectByName(String email) {
		// TODO Auto-generated method stub
		return userMapper.selectUserName(email);
	}
	...
	@Override
	public User selectByUserPasswordColumn(String email, String password) {
		// TODO Auto-generated method stub
		return userMapper.selectuserColumn(email, password);
	}
